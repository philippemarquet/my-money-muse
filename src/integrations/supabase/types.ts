...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      create_space: { Args: { space_name: string }; Returns: string }
      delete_space: { Args: { space_id: string }; Returns: undefined }
      get_household_id: { Args: never; Returns: string }
      is_household_member: { Args: { hid: string }; Returns: boolean }
      is_household_owner: { Args: { hid: string }; Returns: boolean }
      rename_space: {
        Args: { new_name: string; space_id: string }
        Returns: undefined
      }
      set_default_space: { Args: { space_id: string }; Returns: undefined }
